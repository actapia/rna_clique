...
python add_remote_files_to_archive.py "$1.zip" --remote "wget https://cs.uky.edu/~acta225/rna_clique/ec_genomes.tar.xz" --remote-dir "$1/test_data/ec_genomes" --merge-zips --compress-level 9
mv "$1.zip" "$RNA_CLIQUE"
