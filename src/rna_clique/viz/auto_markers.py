...
def ncolor_assigner(
    ...
    By default, the colors assigned come from matplotlib's tab10 colorset. If 
    n > 10, or if prefer_mpl is False, then a set of maximally distinct colors
    is approximated using the glasbeyish library instead. The color palette
